...
def parse_arguments():
    ...
    # this is only used by --re-sign since it does not process
    # --set-options package/allowExpiredCertificates/on, which is the
    # preferred way of enabling this option
    special_group.add_argument("--allow-expired-certificates", dest="allow_expired_certificates", action='store_true',
                               help=argparse.SUPPRESS)
